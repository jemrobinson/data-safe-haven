    ...
    def __init__(
        ...
        nsg_identity_containers = network.NetworkSecurityGroup(
            ...
            security_rules=[
                ...
                network.SecurityRuleArgs(
                    access=network.SecurityRuleAccess.ALLOW,
                    description="Allow LDAP client requests from load balancer over TCP.",
                    destination_address_prefix=subnet_identity_containers_prefix,
                    destination_port_ranges=["389", "1389"],
                    direction=network.SecurityRuleDirection.INBOUND,
                    name="AllowLoadBalancerTCPInbound",
                    priority=NetworkingPriorities.INTERNAL_SRE_IDENTITY_CONTAINERS_LOAD_BALANCING,
                    protocol=network.SecurityRuleProtocol.TCP,
                    source_address_prefix=subnet_identity_containers_load_balancing_prefix,
                    source_port_range="*",
                ),
                network.SecurityRuleArgs(
                    access=network.SecurityRuleAccess.ALLOW,
        ...
        nsg_identity_containers_load_balancing = network.NetworkSecurityGroup(
            ...
            security_rules=[
                ...
                network.SecurityRuleArgs(
                    access=network.SecurityRuleAccess.ALLOW,
                    description="Allow LDAP client requests from user services over TCP.",
                    destination_address_prefix=subnet_identity_containers_load_balancing_prefix,
                    destination_port_ranges=["389", "1389"],
                    direction=network.SecurityRuleDirection.INBOUND,
                    name="AllowUserServicesLDAPClientTCPInbound",
                    priority=NetworkingPriorities.INTERNAL_SRE_USER_SERVICES_CONTAINERS,
        ...
        nsg_workspaces = network.NetworkSecurityGroup(
            ...
            security_rules=[
                ...
                network.SecurityRuleArgs(
                    ...
                    destination_port_ranges=["389", "1389"],
                    direction=network.SecurityRuleDirection.OUTBOUND,
                    name="AllowIdentityServersOutbound_OLD",
                    priority=NetworkingPriorities.INTERNAL_SRE_IDENTITY_CONTAINERS + 10,
                    protocol=network.SecurityRuleProtocol.TCP,
                    source_address_prefix=subnet_workspaces_prefix,
                    source_port_range="*",
                ),
