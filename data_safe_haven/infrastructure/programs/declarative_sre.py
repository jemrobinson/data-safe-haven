...
class DeclarativeSRE:
    ...
    def __call__(self) -> None:
        ...
        #         dns_resource_group_name=dns.resource_group.name,
        #         dns_server_ip=dns.ip_address,
        #         entra_id_application_name=f"sre-{self.sre_name}-apricot",
        #         entra_id_auth_token=self.graph_api_token,
        #         entra_id_tenant_id=self.cfg.shm.entra_id_tenant_id,
        #         location=self.context.location,
        #         networking_resource_group_name=networking.resource_group.name,
        #         shm_fqdn=self.cfg.shm.fqdn,
        ...
        #         dns_server_ip=dns.ip_address,
        #         entra_id_application_fqdn=networking.sre_fqdn,
        #         entra_id_application_name=f"sre-{self.sre_name}-guacamole",
        #         entra_id_auth_token=self.graph_api_token,
        #         entra_id_tenant_id=self.cfg.shm.entra_id_tenant_id,
